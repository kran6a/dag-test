...
describe('[VM] SHIFTR_I', ()=>{
    it('should calculate the remainder', async function () {
        const code: Uint8Array = new Uint8Array([OPS.LABEL, OPS.PUSH, ...bigint2word(8n), OPS.SHIFTR_I, ...bigint2word(1n)]);
        ...
        assert.strictEqual(binary2bigint(ok), 4n, 'The shift produced the expected result');
