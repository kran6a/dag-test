...
describe('[VM] XOR', ()=>{
    it('should XOR the buffers', async function () {
        const code: Uint8Array = new Uint8Array([OPS.LABEL, OPS.PUSH2, ...bigint2word(128n), ...bigint2word(5n), OPS.XOR]);
        ...
        assert.strictEqual(binary2bigint(new Uint8Array(ok)), 133n, 'XOR produced the expected result');
